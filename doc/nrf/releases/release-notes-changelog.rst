...
* nRF52 and nRF53 series development kits:

  * Added :kconfig:option:`CONFIG_NCS_SAMPLE_MCUMGR_BT_OTA_DFU` and :kconfig:option:`CONFIG_NCS_SAMPLE_MCUMGR_BT_OTA_DFU_SPEEDUP` to configure FOTA updates over Bluetooth Low Energy in the default setup.
    ...
    See details in :ref:`ug_nrf52_developing_ble_fota` section of development guide.
...
* Thingy:53:
  ...
  * Simplified board configuration:
    ...
    * Enabled by default MCUboot bootloader in Thingy:53 board configuration.
